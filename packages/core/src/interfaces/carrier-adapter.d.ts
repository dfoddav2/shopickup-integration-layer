...
import type { CarrierResource } from "./carrier-resource";
import type { Shipment, Parcel, RatesResponse, TrackingUpdate } from "../types";
/**
...
export interface CarrierAdapter {
     ...
     */
    createParcel?(shipmentCarrierId: string, req: CreateParcelRequest, ctx: AdapterContext): Promise<CarrierResource>;
    /**
     ...
     */
    createLabel?(parcelCarrierId: string, ctx: AdapterContext): Promise<CarrierResource & {
     ...
     * Capability: PICKUP
     */
    requestPickup?(req: PickupRequest, ctx: AdapterContext): Promise<CarrierResource>;
}
//# sourceMappingURL=carrier-adapter.d.ts.map